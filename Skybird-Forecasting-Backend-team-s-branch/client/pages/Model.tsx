...
function useTrainingAnimation() {
  const full = useMemo(() => {
    ...
    return Array.from({ length: epochs }, (_, i) => {
      ...
      return {
        epoch: i + 1,
        loss: Math.max(0.08, +loss.toFixed(2)),
        acc: Math.min(0.99, +acc.toFixed(2)),
      };
    });
  }, []);
  ...
  return (
    <div className="container mx-auto max-w-7xl px-4 py-10">
      <div className="text-center mb-12 sm:mb-16">
        ...
        >
          See how we analyze weather data to tell you if your parade will be
          impacted by uncomfortable conditions.
        </motion.p>
      </div>
                ...
                <ul className="space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <br />
                      Real-time temperature, humidity, wind, and precipitation.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <br />
                      Patterns and anomalies for specific locations.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <Wind className="h-4 w-4 text-primary mt-0.5" />
                    <div>
                      <strong className="font-medium">Geospatial Data:</strong>
                      <br />
                      Elevation and proximity to water bodies.
                    </div>
                  </li>
                </ul>
              </CardContent>
              ...
              <CardContent>
                ...
                <div className="flex flex-col items-center">
                    ...
                    <svg className="w-full h-auto" viewBox="0 0 400 360">
                      ...
                      >
                        <rect
                          ...
                          stroke="#4a5568"
                        />
                        <text x={352.5} y={48} fill="#f87171" fontWeight={700}>
                          Very Hot
                        </text>
                        <text x={352.5} y={60} fill="#94a3b8">
                          Likelihood
                        </text>
                        ...
                        <rect
                          ...
                          stroke="#4a5568"
                        />
                        <text x={352.5} y={108} fill="#60a5fa" fontWeight={700}>
                          Very Cold
                        </text>
                        <text x={352.5} y={120} fill="#94a3b8">
                          Likelihood
                        </text>
                        ...
                        <rect
                          ...
                          stroke="#4a5568"
                        />
                        <text x={352.5} y={168} fill="#a78bfa" fontWeight={700}>
                          Very Windy
                        </text>
                        <text x={352.5} y={180} fill="#94a3b8">
                          Likelihood
                        </text>
                        ...
                        <rect
                          ...
                          stroke="#4a5568"
                        />
                        <text x={352.5} y={228} fill="#34d399" fontWeight={700}>
                          Very Wet
                        </text>
                        <text x={352.5} y={240} fill="#94a3b8">
                          Likelihood
                        </text>
                        ...
                        <text x={352.5} y={310} fill="#94a3b8">
                          Likelihood
                        </text>
                      </g>
                      ...
                      >
                        ...
                        >
                          <path
                            ...
                            d="M95 150 C 125 135, 145 135, 155 150"
                            fill="none"
                        ...
                        <path
                          className="animated-path"
                          d="M245 150 C 270 150, 290 50, 310 50"
                          fill="none"
                          style={{ animationDelay: "600ms" }}
                        />
                        <path
                          className="animated-path"
                          d="M245 150 C 270 150, 290 110, 310 110"
                          fill="none"
                          style={{ animationDelay: "700ms" }}
                        />
                        <path
                          className="animated-path"
                          d="M245 150 C 270 150, 290 170, 310 170"
                          fill="none"
                          style={{ animationDelay: "800ms" }}
                        />
                        <path
                          className="animated-path"
                          d="M245 150 C 270 150, 290 230, 310 230"
                          fill="none"
                          style={{ animationDelay: "900ms" }}
                        />
                        <path
                          className="animated-path"
                          d="M245 150 C 270 150, 290 290, 310 290"
                          fill="none"
                  ...
                  <p className="text-center text-sm text-muted-foreground mt-4 max-w-md">
                    The AI ingests various data points, processes them through
                    its neural network core, and outputs a probability score for
                    each adverse weather condition.
                  </p>
                </div>
              </CardContent>
            </Card>
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold mb-2 bg-gradient-to-r from-foreground to-primary/60 bg-clip-text text-transparent">
          Interactive Prediction Demo
        </h2>
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
          Simulate a query for your event. Click "Run Demo" to see the predicted
        ...
        <Card className="mx-auto max-w-2xl border-blue-200/40 dark:border-blue-900/60 bg-white/70 dark:bg-slate-800/60 backdrop-blur card-hover">
          <CardHeader className="flex-row items-center justify-between">
            ...
            <Button size="sm" onClick={runDemo} className="gap-2">
              Run Demo
            </Button>
          </CardHeader>
          <CardContent>
            <ChartContainer
              config={{
                p: { label: "Probability", color: "hsl(var(--wc-azure-700))" },
              }}
              className="h-72"
            >

  ...
  return (
    <div className="container mx-auto max-w-6xl px-4 py-10">
      ...
      <p className="mb-8 max-w-3xl text-muted-foreground">
        Our mission is to deliver clear, personalized weather insights using
        reliable data and modern design. Meet the team building it.
      </p>
      <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
        {team.map((m) => {
          ...
          return (
            <Card
              key={`${m.name}-${m.role}`}
              className="transition-all hover:shadow-soft-lg flex flex-col"
            >
              ...
              <CardContent className="text-center">
                ...
                <div
                  className={`mt-1 ${m.name === "Mohamed Hussien" ? "text-xs" : "text-sm"} text-muted-foreground font-semibold`}
                >
                  {m.role}
                </div>

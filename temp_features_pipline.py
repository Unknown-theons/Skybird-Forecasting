...
# --- Configuration ---
# Input files
file_climate = 'climate_data_processed.nc4' # Global climate data
file_wind = 'wind_data_processed.nc4'      # Regional wind data

# Output files
FEATURES_OUT_FILE = 'features_temp.nc4'
CLIMATOLOGY_OUT_FILE = 'climatology_lookup_table.nc4'

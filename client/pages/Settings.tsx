...
import { LogOut, Save, Eye, EyeOff, Settings as SettingsIcon, Shield, Globe } from 'lucide-react';
  ...
  const handlePreferencesUpdate = async (e: React.FormEvent) => {
    ...
    try {
      const updateData: UserUpdateRequest = {
        ...
        preferences: {
          ...user?.preferences,
          ...(preferencesData.preferred_city && { preferred_city: preferencesData.preferred_city }),
        },
      };
                ...
                <form onSubmit={handlePreferencesUpdate} className="space-y-4">
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) => setPreferencesData({ ...preferencesData, temperature_unit: value })}
                      >
                        <SelectTrigger>
                          <SelectValue />
                        </SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => setPreferencesData({ ...preferencesData, preferred_city: e.target.value })}

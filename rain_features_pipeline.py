...
FILE_SLV = 'slv_data.nc4' # Source of most meteorological variables
FILE_RAD = 'rad_data.nc4' # Source of cloud/aerosol variables
FILE_FLX = 'flx_data.nc4' # Source of precipitation (PRECTOT) and flux variables
